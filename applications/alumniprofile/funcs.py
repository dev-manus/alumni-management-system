...
def send_verification_email_old(user, name, email, yoa, yop, prog, spec, reg_no, roll):
    c = {
        ...
        'domain': 'sac.vjti.ac.in',  # request.META['HTTP_HOST'],
        'protocol': 'http',
    }
        ...
        'Messages': [
            {
                ...
                "Bcc": [
                    {
                        "Email": "dean.s@vjti.ac.in",
                        "Name": "Dean Students"
                    }
                ],
                "TemplateID": 821551,
                "TemplateLanguage": True,
                "Subject": "Alumni Connect Portal - VJTI Registration Successful!",
        ...
        'Messages': [
            {
                ...
                "TemplateID": 820446,
                "TemplateLanguage": True,
                "Subject": "Alumni Cell VJTI Wishes you a Very Happy Birthday!",
                "TemplateErrorDeliver": True,
                "TemplateErrorReporting": {
                    "Email": sender_email,
                    "Name": "Error in Message Delivery - Alumni Cell"
