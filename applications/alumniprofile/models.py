...
class Constants:
    ...
    BRANCH = (
        ...
        ('ECE', 'Electronics and Teleommunication Engineering'),
        ('ME', 'Electronics Engineering'),
        ('SM', 'Electrical Egineering'),
        ('NS', 'Mechanical Engineering'),
        ('MT', 'Textile Engineering'),
        ('DS', 'Production Engineering'),
        ('NA', 'Not Applicable')
    )
    ...
    # For Education (other than VJTI Mumbai)
...
def check(sender, instance, created, update_fields, **kwargs):
    if instance.mail_sent_tracker.has_changed('verify') and instance.mail_sent_tracker.previous(
        ...
        mail_sent = send_verification_email("alumni.vjti.ac.in", True, instance)
